...
<HTML>
	...
	<BODY>
      ...
      <p>**8. Google Drive Spreadsheet連携について**</p>
      <p>  *当アプリはGoogle Sheets APIを使用して、ユーザーのトレーニング記録をユーザー自身のスプレッドシートに保存することができます。</p>
      <p>  *データは、進捗分析およびAIによるアドバイス生成の目的にのみ使用し、第三者に提供することはありません。</p>
      <p>**9. 個人情報の開示・訂正・削除**</p>
      <p>ご本人からの個人情報の開示・訂正・削除のご請求については、法令に基づき適切に対応いたします。</p>
      <p>**10. プライバシーポリシーの変更**</p>
